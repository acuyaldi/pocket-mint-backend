...
Scaffold a new feature at `apps/frontend/app/(app)/<name>/` (the target route-group structure — see root AGENTS.md's folder-structure note; do not scaffold under `app/feature/`).
