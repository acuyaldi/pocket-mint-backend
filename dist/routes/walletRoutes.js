...
// POST /api/v1/wallets
walletRouter.post('/', apiKeyAuth_1.requireUser, account_controller_1.createWallet);
// PUT /api/v1/wallets/:id
walletRouter.put('/:id', apiKeyAuth_1.requireUser, account_controller_1.updateWallet);
// DELETE /api/v1/wallets/:id
walletRouter.delete('/:id', apiKeyAuth_1.requireUser, account_controller_1.deleteWallet);
