...
transactionRouter.put('/:id', apiKeyAuth_1.requireUser, transaction_controller_1.TransactionController.update);
transactionRouter.delete('/:id', apiKeyAuth_1.requireUser, transaction_controller_1.TransactionController.delete);
// POST with user auth middleware
transactionRouter.post('/', apiKeyAuth_1.requireUser, transaction_controller_1.TransactionController.create);
