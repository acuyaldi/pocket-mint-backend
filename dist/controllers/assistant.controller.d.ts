...
export declare function createAssistantControllers(application: AssistantApplicationService, conversations: AssistantConversationService, drafts?: AssistantFinancialDraftService, providerRuntime?: AssistantProviderRuntime): {
    ...
    cancelClarification: (req: Request, res: Response, next: NextFunction) => Promise<void>;
};
...
export declare const cancelAssistantClarification: (req: Request, res: Response, next: NextFunction) => Promise<void>;
