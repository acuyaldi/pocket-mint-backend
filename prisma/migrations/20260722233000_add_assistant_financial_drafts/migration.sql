...
ALTER TABLE "assistant_financial_drafts" ADD CONSTRAINT "assistant_financial_drafts_transaction_id_fkey" FOREIGN KEY ("transaction_id") REFERENCES "transactions"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "assistant_idempotency_records" ADD CONSTRAINT "assistant_idempotency_records_transaction_id_fkey" FOREIGN KEY ("transaction_id") REFERENCES "transactions"("id") ON DELETE SET NULL ON UPDATE CASCADE;
